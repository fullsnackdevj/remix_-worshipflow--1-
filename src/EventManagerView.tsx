              ...
              <div className="flex items-center gap-1">
                {panelMode === "view" && selectedEvent && (
                  <>
                    ...
                    <button onClick={() => { if (confirm("Delete this event?")) deleteEvent(selectedEvent.id); }} className="p-1.5 text-gray-400 hover:text-red-500 rounded-lg transition-colors"><Trash2 size={15} /></button>
                  </>
                )}
